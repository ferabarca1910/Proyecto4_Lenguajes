class KnockoutGenerator
  ...
  #
  # El sistema utiliza una distribución lógica para formar los dieciseisavos.
  # No se busca replicar exactamente la llave oficial, sino cumplir con el flujo
  # solicitado: clasificados, rondas eliminatorias, avance automático y campeón.
  ...
  def self.create_round_of_32(qualified_teams, round_of_16_matches)
    # Se divide la lista de clasificados en dos mitades para crear enfrentamientos.
    # La primera mitad se enfrenta contra la segunda mitad en orden inverso.
    # Esto evita cruces repetidos simples y mantiene una llave equilibrada.
